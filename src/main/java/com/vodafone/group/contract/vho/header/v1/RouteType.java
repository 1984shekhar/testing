 ...
 *                           &lt;attribute name="OrderIndex" type="{http://www.w3.org/2001/XMLSchema}integer" /&gt;
 *                         &lt;/extension&gt;
 *                       &lt;/simpleContent&gt;
 *                     &lt;/complexType&gt;
 *                   &lt;/element&gt;
...
public class RouteType {
     ...
     *     
     */
    public void setKeys(RouteType.Keys value) {
        this.keys = value;
    }
    ...
    public static class Keys {
        ...
        protected List<RouteType.Keys.Key> key;
         ...
         * {@link RouteType.Keys.Key }
         * 
         * 
         */
        public List<RouteType.Keys.Key> getKey() {
            if (key == null) {
                key = new ArrayList<RouteType.Keys.Key>();
            }
            return this.key;
        }
